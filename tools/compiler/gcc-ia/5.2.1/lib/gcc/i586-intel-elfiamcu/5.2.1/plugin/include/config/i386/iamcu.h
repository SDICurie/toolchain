...
#undef LIB_SPEC
#define LIB_SPEC "%{!miamcu-libc-reent:--start-group -lee_printf -lc -lgloss --end-group} %{miamcu-libc-reent:--start-group -lee_printf -lc_r -lgloss_r --end-group}"

#undef LINK_GCC_C_SEQUENCE_SPEC
#define LINK_GCC_C_SEQUENCE_SPEC "%{!miamcu-fp-libgcc:-lsoftfp %G %L %G} %{miamcu-fp-libgcc:%G %L %G}"
