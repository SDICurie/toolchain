...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_miamcu_fp_libgcc;
#define x_VAR_miamcu_fp_libgcc do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_miamcu_libc_reent;
#define x_VAR_miamcu_libc_reent do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mpc32;
...
enum opt_code
{
  ...
  OPT_masm_ = 1158,                          /* -masm= */
  OPT_mavx = 1159,                           /* -mavx */
  OPT_mavx2 = 1160,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1161,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1162,  /* -mavx256-split-unaligned-store */
  OPT_mavx512bw = 1163,                      /* -mavx512bw */
  OPT_mavx512cd = 1164,                      /* -mavx512cd */
  OPT_mavx512dq = 1165,                      /* -mavx512dq */
  OPT_mavx512er = 1166,                      /* -mavx512er */
  OPT_mavx512f = 1167,                       /* -mavx512f */
  OPT_mavx512ifma = 1168,                    /* -mavx512ifma */
  OPT_mavx512pf = 1169,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1170,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1171,                      /* -mavx512vl */
  OPT_mbmi = 1172,                           /* -mbmi */
  OPT_mbmi2 = 1173,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1174,                  /* -mbranch-cost= */
  OPT_mcld = 1175,                           /* -mcld */
  OPT_mclflushopt = 1176,                    /* -mclflushopt */
  OPT_mclwb = 1177,                          /* -mclwb */
  OPT_mcmodel_ = 1178,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1179, */                    /* -mcpu= */
  OPT_mcrc32 = 1180,                         /* -mcrc32 */
  OPT_mcx16 = 1181,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1182,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1183,            /* -mdump-tune-features */
  OPT_mf16c = 1184,                          /* -mf16c */
  OPT_mfancy_math_387 = 1185,                /* -mfancy-math-387 */
  OPT_mfentry = 1186,                        /* -mfentry */
  OPT_mfma = 1187,                           /* -mfma */
  OPT_mfma4 = 1188,                          /* -mfma4 */
  OPT_mforce_drap = 1189,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1190,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1191,                       /* -mfpmath= */
  OPT_mfsgsbase = 1192,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1193, */              /* -mfused-madd */
  OPT_mfxsr = 1194,                          /* -mfxsr */
  OPT_mhard_float = 1195,                    /* -mhard-float */
  OPT_mhle = 1196,                           /* -mhle */
  OPT_miamcu = 1197,                         /* -miamcu */
  OPT_miamcu_fp_libgcc = 1198,               /* -miamcu-fp-libgcc */
  OPT_miamcu_libc_reent = 1199,              /* -miamcu-libc-reent */
  ...
  OPT_mmwaitx = 1217,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1218,            /* -mno-align-stringops */
  OPT_mno_default = 1219,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1220,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1221,                  /* -mno-push-args */
  OPT_mno_red_zone = 1222,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1223,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1224,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1225,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1226,                          /* -mpc32 */
  OPT_mpc64 = 1227,                          /* -mpc64 */
  OPT_mpc80 = 1228,                          /* -mpc80 */
  OPT_mpclmul = 1229,                        /* -mpclmul */
  OPT_mpcommit = 1230,                       /* -mpcommit */
  OPT_mpopcnt = 1231,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1232,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1233,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1234,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1235,                        /* -mprfchw */
  OPT_mpush_args = 1236,                     /* -mpush-args */
  OPT_mrdrnd = 1237,                         /* -mrdrnd */
  OPT_mrdseed = 1238,                        /* -mrdseed */
  OPT_mrecip = 1239,                         /* -mrecip */
  OPT_mrecip_ = 1240,                        /* -mrecip= */
  OPT_mrecord_mcount = 1241,                 /* -mrecord-mcount */
  OPT_mred_zone = 1242,                      /* -mred-zone */
  OPT_mregparm_ = 1243,                      /* -mregparm= */
  OPT_mrtd = 1244,                           /* -mrtd */
  OPT_mrtm = 1245,                           /* -mrtm */
  OPT_msahf = 1246,                          /* -msahf */
  OPT_msha = 1247,                           /* -msha */
  OPT_mskip_rax_setup = 1248,                /* -mskip-rax-setup */
  OPT_msoft_float = 1249,                    /* -msoft-float */
  OPT_msse = 1250,                           /* -msse */
  OPT_msse2 = 1251,                          /* -msse2 */
  OPT_msse2avx = 1252,                       /* -msse2avx */
  OPT_msse3 = 1253,                          /* -msse3 */
  OPT_msse4 = 1254,                          /* -msse4 */
  OPT_msse4_1 = 1255,                        /* -msse4.1 */
  OPT_msse4_2 = 1256,                        /* -msse4.2 */
  OPT_msse4a = 1257,                         /* -msse4a */
  /* OPT_msse5 = 1258, */                    /* -msse5 */
  OPT_msseregparm = 1259,                    /* -msseregparm */
  OPT_mssse3 = 1260,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1261,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1262,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1263,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1264,            /* -mstringop-strategy= */
  OPT_mtbm = 1265,                           /* -mtbm */
  OPT_mtls_dialect_ = 1266,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1267,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1268,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1269,                         /* -mtune= */
  OPT_mveclibabi_ = 1270,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1271,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1272,                    /* -mvzeroupper */
  OPT_mx32 = 1273,                           /* -mx32 */
  OPT_mxop = 1274,                           /* -mxop */
  OPT_mxsave = 1275,                         /* -mxsave */
  OPT_mxsavec = 1276,                        /* -mxsavec */
  OPT_mxsaveopt = 1277,                      /* -mxsaveopt */
  OPT_mxsaves = 1278,                        /* -mxsaves */
  OPT_n = 1279,                              /* -n */
  OPT_no_canonical_prefixes = 1280,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1281,              /* -no-integrated-cpp */
  OPT_nocpp = 1282,                          /* -nocpp */
  OPT_nodefaultlibs = 1283,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1284,                   /* -nostartfiles */
  OPT_nostdinc = 1285,                       /* -nostdinc */
  OPT_nostdinc__ = 1286,                     /* -nostdinc++ */
  OPT_nostdlib = 1287,                       /* -nostdlib */
  OPT_o = 1288,                              /* -o */
  OPT_p = 1289,                              /* -p */
  OPT_pass_exit_codes = 1290,                /* -pass-exit-codes */
  /* OPT_pedantic = 1291, */                 /* -pedantic */
  OPT_pedantic_errors = 1292,                /* -pedantic-errors */
  OPT_pg = 1293,                             /* -pg */
  OPT_pie = 1294,                            /* -pie */
  OPT_pipe = 1295,                           /* -pipe */
  OPT_print_file_name_ = 1296,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1297,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1298,          /* -print-multi-directory */
  OPT_print_multi_lib = 1299,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1300,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1301,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1302,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1303,               /* -print-prog-name= */
  OPT_print_search_dirs = 1304,              /* -print-search-dirs */
  OPT_print_sysroot = 1305,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1306,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1307,                          /* -quiet */
  OPT_r = 1308,                              /* -r */
  OPT_remap = 1309,                          /* -remap */
  OPT_s = 1310,                              /* -s */
  OPT_s_bc_abi = 1311,                       /* -s-bc-abi */
  OPT_save_temps = 1312,                     /* -save-temps */
  OPT_save_temps_ = 1313,                    /* -save-temps= */
  OPT_shared = 1314,                         /* -shared */
  OPT_shared_libgcc = 1315,                  /* -shared-libgcc */
  /* OPT_specs = 1316, */                    /* -specs */
  OPT_specs_ = 1317,                         /* -specs= */
  OPT_static = 1318,                         /* -static */
  OPT_static_libasan = 1319,                 /* -static-libasan */
  OPT_static_libgcc = 1320,                  /* -static-libgcc */
  OPT_static_libgcj = 1321,                  /* -static-libgcj */
  OPT_static_libgfortran = 1322,             /* -static-libgfortran */
  OPT_static_libgo = 1323,                   /* -static-libgo */
  OPT_static_liblsan = 1324,                 /* -static-liblsan */
  OPT_static_libmpx = 1325,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1326,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1327,               /* -static-libstdc++ */
  OPT_static_libtsan = 1328,                 /* -static-libtsan */
  OPT_static_libubsan = 1329,                /* -static-libubsan */
  /* OPT_std_c__03 = 1330, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1331, */                /* -std=c++0x */
  OPT_std_c__11 = 1332,                      /* -std=c++11 */
  OPT_std_c__14 = 1333,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1334, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1335, */                /* -std=c++1y */
  OPT_std_c__1z = 1336,                      /* -std=c++1z */
  OPT_std_c__98 = 1337,                      /* -std=c++98 */
  OPT_std_c11 = 1338,                        /* -std=c11 */
  /* OPT_std_c1x = 1339, */                  /* -std=c1x */
  /* OPT_std_c89 = 1340, */                  /* -std=c89 */
  OPT_std_c90 = 1341,                        /* -std=c90 */
  OPT_std_c99 = 1342,                        /* -std=c99 */
  /* OPT_std_c9x = 1343, */                  /* -std=c9x */
  OPT_std_f2003 = 1344,                      /* -std=f2003 */
  OPT_std_f2008 = 1345,                      /* -std=f2008 */
  OPT_std_f2008ts = 1346,                    /* -std=f2008ts */
  ...
  OPT_std_gnu__98 = 1356,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1357,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1358, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1359, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1360,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1361,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1362, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1363, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1364,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1365, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1366, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1367, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1368,                     /* -std=legacy */
  OPT_symbolic = 1369,                       /* -symbolic */
  OPT_t = 1370,                              /* -t */
  OPT_time = 1371,                           /* -time */
  OPT_time_ = 1372,                          /* -time= */
  OPT_traditional = 1373,                    /* -traditional */
  OPT_traditional_cpp = 1374,                /* -traditional-cpp */
  OPT_trigraphs = 1375,                      /* -trigraphs */
  OPT_u = 1376,                              /* -u */
  OPT_undef = 1377,                          /* -undef */
  OPT_v = 1378,                              /* -v */
  OPT_version = 1379,                        /* -version */
  OPT_w = 1380,                              /* -w */
  OPT_wrapper = 1381,                        /* -wrapper */
  OPT_x = 1382,                              /* -x */
  OPT_z = 1383,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
